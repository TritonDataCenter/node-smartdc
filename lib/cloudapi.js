...
CloudAPI.prototype.exportImage = function (account,
    ...
    var self = this;
    return this._request(sprintf(IMAGE, account, name), null, function (req) {
        addToQuery(req, { action: 'export', manta_path: mantaPath });
...
CloudAPI.prototype.getMachineMetadata = function (account,
    ...
    return this._request(path, {credentials: getCredentials}, function (req) {
        return self._get(req, callback, noCache);
    });
};
 ...
 * @throws {TypeError} on bad input.
 */
CloudAPI.prototype.getRoleTags = function (account, resource, cb) {
    ...
    resource = '/' + p.join('/');
    var self = this;
    return this._request(resource, null, function (req) {
        return self._get(req, function (err, obj, headers) {
            if (err) {
                return cb(err);
            } else {
...
CloudAPI.prototype.GetRoleTags = CloudAPI.prototype.getRoleTags;
...
CloudAPI.prototype.setRoleTags = function (account, resource, roleTags, cb) {
...
CloudAPI.prototype.SetRoleTags = CloudAPI.prototype.setRoleTags;
