...
var cli_fabric_nets = require('./cli/fabric-nets');
var cli_fabric_vlans = require('./cli/fabric-vlans');
...
for (_proto in cli_fabric_nets) {
    CloudAPI.prototype[_proto] = cli_fabric_nets[_proto];
}

for (_proto in cli_fabric_vlans) {
    CloudAPI.prototype[_proto] = cli_fabric_vlans[_proto];
}
