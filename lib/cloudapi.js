 ...
 * @throws {TypeError} on bad input.
 */
CloudAPI.prototype.listMachineTags = function (account, machine, callback, noCache) {
    if (typeof (machine) === 'function') {
        callback = machine;
        machine = account;
        account = this.account;
 ...
 * @throws {TypeError} on bad input.
 */
CloudAPI.prototype.getMachineTag = function (account, machine, tag, callback, noCache) {
