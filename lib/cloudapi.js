...
CloudAPI.prototype.listMachines = function(account, options, tags, callback) {
  ...
  return this._request(sprintf(MACHINES, account), null, function(req) {
    ...
    return self.client.get(req, function(err, request, res, obj) {
      ...
      if (res.headers['x-resource-count'] && res.headers['x-query-limit'])
...
CloudAPI.prototype.updateMachineMetadata = function(account,
  ...
  var self = this;
  return this._request(sprintf(METADATA, account, m), metadata, function(req) {
  ...
  if (this.basicAuth) {
    ...
    if (!this.sshAgent) {
      ...
      return this.sshAgent.sign(this.key, new Buffer(now), function(err, sig) {
        if (!err && sig) {
          var algo = /DSA/i.test(self.key) ? 'dsa-sha1' : 'rsa-sha1';
          obj.headers.Authorization = sprintf(SIGNATURE,
                                              self.keyId,
                                              algo,
                                              sig.signature);
